...
echo -e "\"environment.sh\" named \"second.sh\" now, run it with \"download.sh\". "
echo "--- Important --- If the computer memory is less than 2G\(2048M\) please run \"swap.sh\" before run \"second.sh\" and \"download.sh\"."
# Version Information
